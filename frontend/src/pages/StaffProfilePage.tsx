      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-x-8 gap-y-4 sm:grid-cols-3">
            <InfoRow label="Emp Code"    value={emp.emp_code} />
            <InfoRow label="Gender"      value={emp.gender} />
            <InfoRow label="Date of Join" value={fmt(emp.doj)} />
            <InfoRow label="Date of Birth" value={fmt(emp.dob)} />
            <InfoRow label="Email"       value={emp.email} />
            <InfoRow label="Dept Code"   value={emp.department_code} />
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm flex flex-col gap-3">
          ...
          <Link
            ...
            className="flex items-center gap-2 rounded-xl bg-blue-600 px-4 py-3 text-sm font-semibold text-white shadow hover:bg-blue-700 transition-colors"
          >
          ...
          <Link
            ...
            className="flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-100 transition-colors"
          >
            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
