...
function DashboardCard({ title, desc, icon, to }: { title: string, desc: string, icon: string, to: string }) {
  return (
    <Link to={to} className="block group rounded-2xl bg-white border border-slate-200 shadow-sm hover:shadow-md hover:border-emerald-300 transition-all p-6">
      ...
      <h3 className="text-lg font-bold text-slate-800 mb-1 group-hover:text-emerald-700">{title}</h3>
